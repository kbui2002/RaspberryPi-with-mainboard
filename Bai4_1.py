    ...
    while True:
        if GPIO.input(BT1) == 0:
            ...
            if currentPWD2 != 0:
                ...
                currentPWD1 = (currentPWD1 + upPWD) if currentPWD1 + \
                    upPWD < 100 else 100
                if currentPWD1 == 0:
                    currentPWD1 == 20
                PWD1.ChangeDutyCycle(currentPWD2)
                print("Toc do hien tai: " +
                      str(currentPWD1) + " theo chieu thuan")
                currentPWD2 = 0
                time.sleep(0.5)
        ...
        if GPIO.input(BT2) == 0:
            ...
            currentPWD1 = (currentPWD1 - downPWD) if currentPWD1 - \
                downPWD > 0 else 0
        ...
        if GPIO.input(BT3) == 0:
            ...
            currentPWD2 = (currentPWD2 + upPWD) if currentPWD2 + \
                upPWD < 100 else 100
            if currentPWD2 == 0:
                currentPWD2 = 20
        ...
        if GPIO.input(BT4) == 0:
            ...
            currentPWD2 = (currentPWD2 - downPWD) if currentPWD2 - \
                downPWD > 0 else 0
            print("Toc do hien tai: " + '-' + str(currentPWD2))
            PWD2.ChangeDutyCycle(currentPWD2)
            currentPWD1 = 0
